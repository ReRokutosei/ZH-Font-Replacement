...
def set_xlight_names(font):
    font.fontname = 'MicrosoftYaHeiXlight'
    font.familyname = 'Microsoft YaHei'
    ...
    font.sfnt_names = (
        ...
        ('English (US)', 'UniqueID', 'Microsoft YaHei Xlight'),
        ('English (US)', 'SubFamily', 'Xlight'),
        ('English (US)', 'Version', get_version(font)),
        ('English (US)', 'Copyright', conf.COPYRIGHT),
        ('Chinese (PRC)', 'Family', '微软雅黑'),
...
def set_xlight_ui_names(font):
    font.fontname = 'MicrosoftYaHeiUIXlight'
    font.familyname = 'Microsoft YaHei UI'
    ...
    font.sfnt_names = (
        ...
        ('English (US)', 'UniqueID', 'Microsoft YaHei UI Xlight'),
        ('English (US)', 'SubFamily', 'Xlight'),
        ('English (US)', 'Version', get_version(font)),
        ('English (US)', 'Copyright', conf.COPYRIGHT),
        ('Chinese (PRC)', 'Family', '微软雅黑 UI'),
        ('Chinese (PRC)', 'Fullname', '微软雅黑 UI Xlight')
    )
...
def gen_xlight():
    fs.copy(conf.TEMP_DIR + '/' + conf.XLIGHT_SOURCE + '.ttf',
            conf.TEMP_DIR + '/' + conf.XLIGHT_SOURCE + '-UI.ttf')

    font = open_font(conf.TEMP_DIR + '/' + conf.XLIGHT_SOURCE + '.ttf')
    remove_gasp(font)
    set_cleartype(font)
    set_xlight_names(font)

    font_ui = open_font(conf.TEMP_DIR + '/' + conf.XLIGHT_SOURCE + '-UI.ttf')
    remove_gasp(font_ui)
    set_cleartype(font_ui)
    set_xlight_ui_names(font_ui)

    font.generateTtc(conf.TEMP_DIR + '/msyhxl.ttc',
                     font_ui, ttcflags=('merge'), layer=1)
